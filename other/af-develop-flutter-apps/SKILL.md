---
name: af-develop-flutter-apps
description: Develop Flutter mobile applications within AgentFlow monorepo projects. Use when building with Widgetbook, writing widget tests, configuring platform channels, or structuring Flutter packages.
