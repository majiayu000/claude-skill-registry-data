...
This is a recipe shortcut. It pre-selects the workflow-hello-world recipe but the **gtm-meta-skill governs the entire session**.
...
3. **Additionally read** the workflow-hello-world recipe at `../gtm-meta-skill/recipes/workflows-hello-world.md` (relative to this file) for the specific workflow.
