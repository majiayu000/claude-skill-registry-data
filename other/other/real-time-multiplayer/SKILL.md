---
id: SKL-real-REALTIMEMULTIPLAYER
name: Real Time Multiplayer
description: Real-time multiplayer enables simultaneous gameplay across networks.
  This guide covers networking, state synchronization, and lag compensation for building
  responsive multiplayer games that handle net
version: 1.0.0
status: active
owner: '@cerebra-team'
...
* **Conflicts with**: None
* **Related Skills**: [matchmaking](38-gaming-features/matchmaking/SKILL.md), [leaderboards](38-gaming-features/leaderboards/SKILL.md), [websocket-patterns](34-real-time-features/websocket-patterns/SKILL.md)
