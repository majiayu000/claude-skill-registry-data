...
This is a recipe shortcut. It pre-selects the clay-to-deepline recipe but the **gtm-meta-skill governs the entire session**.
...
3. **Additionally read** the clay-to-deepline recipe at `../gtm-meta-skill/recipes/clay-to-deepline.md` (relative to this file) for the specific workflow.
