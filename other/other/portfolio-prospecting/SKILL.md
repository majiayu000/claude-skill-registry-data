...
This is a recipe shortcut. It pre-selects the portfolio-prospecting recipe but the **gtm-meta-skill governs the entire session**.
...
3. **Additionally read** the portfolio-prospecting recipe at `../gtm-meta-skill/recipes/portfolio-prospecting.md` (relative to this file) for the specific workflow.
