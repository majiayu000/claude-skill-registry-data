...
**Cross-cutting learnings:** See `.claude/LEARNINGS.md` → "Supabase/Database" section for RLS+GRANT two-layer patterns, common 403 error causes, and GRANT audit checklist.
