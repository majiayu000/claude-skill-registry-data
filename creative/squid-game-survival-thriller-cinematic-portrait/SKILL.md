...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019a240d-3f32-74b6-a201-3961112cd042`).

Command form:

```bash
betterprompt generate 019a240d-3f32-74b6-a201-3961112cd042 \
  [--image-input-url <url>] \
